...
?>
    ...
    <div>
      <link href="./clinicaindex.css" rel="stylesheet" />
      ...
      <div class="home-container1">
        <navbar8-wrapper class="navbar8-wrapper">
          ...
          <header class="navbar8-container1">
            ...
            <img src="http://localhost/clinicaturn/views/CLINICA_KRAUSE.png" alt="Medical Appointment Scheduler Logo" class="navbar8-image1" />
              <div data-thq="thq-navbar-nav" class="navbar8-desktop-menu">
                <nav class="navbar8-links1">
                  <a href="clinicaweb.php">
                ...
                <a href="ClinicaKrause/login.php">
                  <button
                ...
                <div class="navbar8-nav">
                  <div class="navbar8-top">
                    <img
                      ...
                      src="http://localhost/clinicaturn/views/CLINICA_KRAUSE.png"
                      class="navbar8-logo"
                    />
                  ...
                  <div class="search-container">
                    <form action="controller/buscar.php" method="get">
                      <div class="field-container">
                        ...
                        <button class="btn-naranja btn-lg mt-3" type="submit">Buscar</button>
                      </div>
                    </form>
                  </div>
                </div>
